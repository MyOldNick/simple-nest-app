...
describe('AuthController', () => {
  ...
  describe('login', () => {
    ...
    it('should throw UnauthorizedException if login fails', async () => {
      ...
      await expect(authController.login(mockAuthDto)).rejects.toThrow(
        UnauthorizedException,
      );
      expect(authService.login).toHaveBeenCalledWith(mockAuthDto);
    });
  ...
  describe('refresh', () => {
    ...
    it('should throw UnauthorizedException if refresh token is invalid', async () => {
      ...
      await expect(authController.refresh(mockRefreshToken)).rejects.toThrow(
        UnauthorizedException,
      );
      expect(authService.refresh).toHaveBeenCalledWith(mockRefreshToken);
    });
    ...
    it('should throw InternalServerErrorException on unexpected error', async () => {
      authService.refresh.mockRejectedValue(
        new InternalServerErrorException('Token refresh failed'),
      );
